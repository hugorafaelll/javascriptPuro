...
*/
    ...
    let tom = "tom";
    let firstTom = "hanks"
    let segundoTom = "cruise"
    let MyfavoriteTom = tom + " "+ segundoTom;
...
const rename = programmingLanguage.slice(0,1)
...
const resumo = mozilla.slice(0,1);
const resumo2 = mozilla.slice(8,9);
const resumo3 = mozilla.slice(18,19);
const  resumoGeral = (resumo+resumo2+resumo3).toLowerCase()
...
const resumindo = summerMessage.toLowerCase()
...
const resumindo2 = winterMessage.toUpperCase()
console.log(resumindo2)
...
const removendo = harryPotterAuthor.slice(0,5)
...
*/
const theBest = "Moonlight"
const bestMovie = 'E o Oscar de melhor filme vai para: "La la land"!'
const realBestMovie = `E o Oscar de melhor filme vai para: ${theBest}!`
